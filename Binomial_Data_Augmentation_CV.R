...
for(dataset in datasets){
    ...
    #   i=1
        ...
        Predictions <- rbind(
           ...
           data.frame(
              ...
              Opt_Threshold_Clasif=Top_Threshold
  ...
  write.csv(Summary_final,file=file.path(results_dir,"Accuracy_A_Val_V3.csv"))
  write.csv(Predictions_final,file=file.path(results_dir,"ALL_Predictions_Val_V3.csv"))
}
